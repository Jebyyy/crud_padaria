	...
	<body >  
        <?php
            ...
            if (isset($_SESSION ['login'])) {      // Se existe usuário logado 
                header("location: /atp02_michelmartins/funciolistar.php");  // Vai para as funcionalidades do site
                exit();
            }
        ?>
        <!-- Menu Superior -->
        <div class="w3-top" id="LoginCadastro" >
            <div class="w3-row w3-white w3-padding" >
                <div class="w3-half" style="margin:0 0 0 0"><a href="."><img src='imagens/logo.jpg' alt='  Padaria MM '></a></div>
		...
		<div class="w3-main w3-container" style="margin-left:270px;margin-top:130px;">
            ...
            <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey" >
                <h1 class="w3-jumbo" style="font-family: Arapey;">Padaria</h1>
